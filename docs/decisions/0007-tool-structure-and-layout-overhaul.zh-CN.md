...
已接受（2026-06-07）。建立在 [0001](0001-provider-registry-runtime.zh-CN.md)（provider/registry/runtime）之上。移除 [0005](0005-stable-subagent-orchestration.zh-CN.md)/[0006](0006-async-subagent-runner.zh-CN.md) 曾保持推迟的 teammate 子系统。
